...
export class HomeComponent {
  ...
  getAll(){
    ...
    this.http.post(enpoint, data, {
      headers: {
        "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..BcoxoWpl8uMdnfGygYpfPrQMxnhiebC4faZrY0xslTY"
      }
    }).subscribe({
      next: (res: any)=> {
        this.result.set(res);
